<div class="wrap">
  ...
  <i class="fa fa-square-o fa-stack-2x"></i><i class="fa fa-plus fa-stack-1x"></i>
</span> %s </h2>',esc_html__('Nuevo propietario','candepalleiro-management'));
    ?>  
    
    <!-- form --> 
    <form name="my_form" method="post">
    <?php wp_nonce_field( 'new_owner', 'new_owner_nonce_field' ); 
        ...
        <div id="post-body">
            ...
            <!--container 2-->
                ...
                <div class="text-align-center">
                        <input type="hidden" name="action" value="owner-new" />
                        <input name="save" type="submit" class="button button-primary button-large" id="publish" accesskey="p" value="<?php _e("INSERTAR",'candepalleiro-management');?>">
                        </div>
